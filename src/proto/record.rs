    ...
    pub fn write(&self, buffer: &mut BytePacketBuffer) -> Result<usize> {
        ...
        match *self {
            Record::A {
                ...
                buffer.write_u16(Query::A.to_num())?;
                buffer.write_u16(1)?;
            ...
            Record::NS {
                ...
                buffer.write_qname(domain)?;
                buffer.write_u16(Query::NS.to_num())?;
                buffer.write_u16(1)?;
                buffer.write_u32(ttl)?;
            ...
            Record::CNAME {
                ...
                buffer.write_qname(domain)?;
                buffer.write_u16(Query::CNAME.to_num())?;
                buffer.write_u16(1)?;
                buffer.write_u32(ttl)?;
            ...
            Record::MX {
                ...
                buffer.write_qname(domain)?;
                buffer.write_u16(Query::MX.to_num())?;
                buffer.write_u16(1)?;
                buffer.write_u32(ttl)?;
            ...
            Record::AAAA {
                ...
                buffer.write_qname(domain)?;
                buffer.write_u16(Query::AAAA.to_num())?;
                buffer.write_u16(1)?;
                buffer.write_u32(ttl)?;
                buffer.write_u16(16)?;
